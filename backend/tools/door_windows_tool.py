...
def doors_windows_logic() -> dict:
    try:
        ...
        number_of_bathrooms = shared_inputs["number_of_bathrooms"]   # per floor
        number_of_kitchens = shared_inputs["number_of_kitchens"]     # per floor
        ...
        room_windows = number_of_rooms * number_of_floors
        bathroom_windows = number_of_bathrooms * number_of_floors
        kitchen_windows = number_of_kitchens * number_of_floors
        washing_window = 1
        balcony_window = 1
        tower_window = 1
