...
def get_initial_inputs():
    ...
    try:
        ...
        shared_inputs["number_of_rooms"] = int(input("Number of rooms (per floor): "))
        shared_inputs["number_of_bathrooms"] = int(input("Number of bathrooms (per floor): "))
        shared_inputs["number_of_kitchens"] = int(input("Number of kitchens (per floor): "))
